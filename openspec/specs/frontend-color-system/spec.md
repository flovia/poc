...
Frontend color system defines semantic color aliases and usage rules so component visuals communicate consistent meaning while preserving the existing base palette.
