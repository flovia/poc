...
describe("WalletScreen", () => {
  ...
  test("stacks upsell, co-usage, and activity timeline as full-width rows after the support row", () => {
    const html = renderWalletScreen();
    ...
    const upsellSection = html.slice(upsellStart, coUsageStart);
    ...
    expect(upsellSection).toContain(
      'class="wallet-screen-span-12 wallet-grid-item wallet-evidence-upsell"',
    );
