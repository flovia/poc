...
describe("inferBrandDomain", () => {
  ...
  test("strips x402 / api / www / pro-api infra prefixes", () => {
    expect(
      inferBrandDomain({ fqn: "z/x", serviceUrl: "https://x402.example.com" }).domain,
    ).toBe("example.com");
    expect(
      inferBrandDomain({ fqn: "z/x", serviceUrl: "https://api.example.com" }).domain,
    ).toBe("example.com");
    expect(
      inferBrandDomain({ fqn: "z/x", serviceUrl: "https://www.example.com" }).domain,
    ).toBe("example.com");
    expect(
      inferBrandDomain({ fqn: "z/x", serviceUrl: "https://pro-api.example.com" }).domain,
    ).toBe("example.com");
  });
